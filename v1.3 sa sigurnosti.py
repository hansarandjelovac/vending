...
def motorLevi():
    ...
    #Kad pritisnes prekidac, fioka se vrati skroz nazad i ceka 10 sekundi
        ...
        while True:
            ...
            if GPIO.input(17) == True and GPIO.input(6) == False and GPIO.input(12) == False and prekidac1 == "pocetak":
...
def motorDesni():
    ...
    if GPIO.input(26) == True and GPIO.input(27) == True and GPIO.input(22) == False and GPIO.input(8) == False: # and prekidac == "pocetak":
        ...
        while True:
            ...
            if GPIO.input(27) == True and GPIO.input(22) == False and GPIO.input(8) == False and prekidac == "pocetak":
