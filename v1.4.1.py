...
def motorLevi():
    ...
    if GPIO.input(13) == True and GPIO.input(12) == False:
        time.sleep(2)
        if GPIO.input(13) == True and GPIO.input(12) == False:
            GPIO.output(10,1)                                     
            GPIO.output(9,1)                                      
    ...
    #Kad pritisnes prekidac, fioka se vrati skroz nazad i ceka 10 sekundi
        ...
        while True:
            ...
            if GPIO.input(17) == True and GPIO.input(6) == False and GPIO.input(12) == False and prekidac1 == "pocetak" and GPIO.input(13) == True:
...
def motorDesni():
    ...
    if GPIO.input(26) == True and GPIO.input(27) == True and GPIO.input(22) == False and GPIO.input(8) == False: # and prekidac == "pocetak":
        ...
        while True:
            ...
            if GPIO.input(27) == True and GPIO.input(22) == False and GPIO.input(8) == False and prekidac == "pocetak" and GPIO.input(21) == True:
